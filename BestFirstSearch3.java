...
public class BestFirstSearch3
{
    ...
    int bestStartingNode;

    public int bestTour()
    {
        int bestTour = 999999999;

        for (int i = 0; i < (numberOfNodes-1); i++)         
            {
                int distance = 0;
                distance = bestFirstSearch(matrix, i);
                if(distance < bestTour)
                {
                    bestTour = distance;
                    bestStartingNode = i;
                    System.out.println("Starting node = " + bestStartingNode);
                }
            }
        return bestTour;
    }
    ...
    public void finalMethod(Matrix array)
    {
        matrix = array;
        ...
        System.out.print("LENGTH = " + bestTour() + "," + "\n");
        bestFirstSearch(matrix, bestStartingNode);
    ...
    public int bestFirstSearch(Matrix array, int source)
    {
        order.clear();
        source = source;
        matrix = array;
